...
| `rarity.py` | Badge rarità (sigla community UR/ScR/QCSR… + colori foil) e `rarity_rank` per l'ordinamento. Spostato da `modules/market_watch/` al core nella v1.1.5, stesso motivo. Match per SOTTOSTRINGA dal più specifico al più generico ("rare" per ultimo!). |
